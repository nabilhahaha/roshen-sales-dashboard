...
import { renderAmendmentsTab } from './amendments.tab.js';
...
function paintDocumentView() {
  ...
  SHELL = renderDocumentShell(ROOT, {
    ...
    tabs: [
      ...
      { id: 'amendments', label: 'Amendments', icon: '📝', render: (elx) => renderAmendmentsTab(elx, { orderId: ED.id, orderNumber: ED.header.order_number, supplier: ED.header.supplier }) },
